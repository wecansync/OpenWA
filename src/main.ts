// env-loader MUST be the first import: it loads .env files into process.env as a
// side effect before any other module (e.g. app.module.ts) is evaluated, since
// those modules read process.env at load time (not inside async factories).
import './env-loader';
...
// (The actual loading is done in env-loader.ts)
